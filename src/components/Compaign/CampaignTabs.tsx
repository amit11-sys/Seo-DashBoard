...
//   useEffect(() => {
//     setLanguages(location_and_language.allLanguages);
...
//   const fetchSuggestions = debounce((e: React.ChangeEvent<HTMLInputElement>) => {
//     const query = e.target.value;
...
//           <TabsTrigger
//             value="account"
//             className="rounded-full group relative flex-1 p-3 text-sm font-semibold text-gray-600 transition-all duration-300 ease-in-out hover:shadow-md hover:bg-blue-100 hover:text-blue-700 data-[state=active]:bg-[#273F4F] data-[state=active]:text-white data-[state=active]:shadow-lg"
//           >
//             <span className="flex text-2xl items-center justify-center gap-2">
//               Campaign Info
//               {campaignValid && (
//                 <FaCircleCheck className="text-green-700 font-bold group-data-[state=active]:text-white transition-colors duration-200" size={25} />
//               )}
//             </span>
//           </TabsTrigger>
...
//               </CardContent>
//               <CardFooter>
//                 <CustomButton buttonName="Continue to Keywords" onClick={handleCampaignSubmit} />
//               </CardFooter>
//             </Card>
//           </motion.div>
//         </TabsContent>
...
//                         autoComplete="off"
//                         {...form.register("searchLocationCode")}
...
//                         <DropDownList
//                           showArrow={false}
//                           listData={location_and_language.allLocations}
...
//           </motion.div>
//           <div className="w-full flex gap-4 items-end justify-end">
//             <BlueButton transparent={true} buttonName="Previous" onClick={() => setActiveTab("account")} />
//             <BlueButton onClick={onFinalSubmit} buttonName="Finish" />
//           </div>
//         </TabsContent>
//       </Tabs>
