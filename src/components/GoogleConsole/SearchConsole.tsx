...
// if(searchConsoleGraphData?.length === 0 && searchConsoleTableData?.length === 0){
// // If no data, show "No Data" window
// return (
...
//   const handleConnectClick = (integration: string) => {
//     if (integration === "Google Search Console") setIsConsoleData(true);
//     if (integration === "Google Analytics") setIsAnalyticsData(true);
//   };
...
//     };
//     fetchData();
//   }, [campaignId, dimension, date,dataWithDimension]);
...
//   if (
//     (!searchConsoleGraphData || searchConsoleGraphData.length === 0) &&
//     (!searchConsoleTableData || searchConsoleTableData.length === 0)
//   ) {
//     return (
//       <div className="relative w-full h-[70vh] flex items-center justify-center bg-gray-100">
//         <div className="absolute inset-0 bg-white/60 backdrop-blur-md">
