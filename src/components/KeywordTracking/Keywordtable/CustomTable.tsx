...
import { fetchLocation } from "@/actions/locations_Language/queries";
import { Search } from "lucide-react";
import { useLoader } from "@/hooks/useLoader";
 import sethighlightKeyword from "@/actions/hightlightKeywords";
...
const CustomTable = ({
  ...
  // const keyword = "basement renovation company fort wayne";
  // const spyglassBase =
  //   "https://agencydashboard.io/spyglass/ODIyNDYxLXwtNDQ1MDAtfC0xNzU0OTgyNDE1";

  const handleClick = (spyglassBase: string, keyword: string) => {
  try {
                ...
                >
                 ...
                 transition-all duration-300 ease-out"
                      >
                        ...
                        > */}
                        <button onClick={()=> handleHighlightClick(data?.checkUrl)}>
