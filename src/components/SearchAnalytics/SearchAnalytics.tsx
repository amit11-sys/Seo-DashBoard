...
//     const response = await fetch("http://localhost:3000/api/v1/pdf/generate-pdf", {
//       method: "POST",
    ...
    return (
       <div className="relative w-full h-[70vh] flex items-center justify-center bg-gray-100">
        <div className="absolute inset-0 bg-white/60 backdrop-blur-md flex flex-col justify-center items-center">
          <div className="flex items-center justify-center bg-white w-full gap-3 my-6">
            <FcGoogle className="text-blue-600 text-4xl" />
            <div>
              <div className="font-bold text-4xl">Google Analytics Overview</div>
            </div>
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-gray-600 font-medium">Fetching analytics data...</p>
        </div>
      </div>
        </div>
      </div>
        ...
        <div className="absolute inset-0 bg-white/60 backdrop-blur-md flex flex-col justify-center items-center">
          ...
          <div className="bg-white shadow-lg rounded-xl p-8 text-center max-w-md mx-auto">
            ...
            <p className="text-gray-500 mb-6">
              You need to connect Google Search Analytics. Please login to continue.
            </p>
            <a
    ...
    <tbody className="bg-white">
      {pageTitle.length > 0 ? (
        pageTitle.map((item: any, index: number) => (
          ...
          >
            <td className="p-3 text-gray-800 text-sm">{item?.pageTitle || "-"}</td>
            <td className="p-3 text-gray-800 text-sm">{item?.userCount || "0"}</td>
          </tr>
        ))
      ) : (
        <tr>
